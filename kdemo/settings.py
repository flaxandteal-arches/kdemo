...
DATATYPE_LOCATIONS.append("kdemo.datatypes")
FUNCTION_LOCATIONS.append("kdemo.functions")
ETL_MODULE_LOCATIONS.append("kdemo.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("kdemo.search_components")
...
SECRET_KEY = "django-insecure-t9@2nk$(b*++ks59s7(4(h^c3#8o@(c^deej611m!1zxd=cjbd"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "kdemo.urls"
ROOT_HOSTCONF = "kdemo.hosts"
...
ELASTICSEARCH_PREFIX = "kdemo"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'kdemo.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "kdemo",  # Ensure the project is listed before any other arches applications
)
...
# ES_MAPPING_MODIFIER_CLASSES = ["kdemo.search.es_mapping_modifier.EsMappingModifier"]
